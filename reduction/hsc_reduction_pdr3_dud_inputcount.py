...
cat = Table(fitsio.read('/global/cfs/cdirs/desi/target/analysis/truth/parent/original/hsc-pdr3-dud-no_mag_limit_inputcount.fits'))
print(len(cat))
...
cat.write('/global/cfs/cdirs/desi/target/analysis/truth/parent/hsc-pdr3-dud-no_mag_limit_inputcount-reduced.fits')
