...
cat = Table(fitsio.read('/pscratch/sd/r/rongpu/tmp/iron/zcatalog/v2/zall/zall-pix-iron.fits'))
print(len(cat), len(np.unique(cat['TARGETID'])))
...
cat.write('/global/cfs/cdirs/desi/target/analysis/truth/parent/zall-pix-iron-unique.fits')
